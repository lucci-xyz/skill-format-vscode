...
**Before** - a typical hand-written skill:

```yaml
---
description: Use this skill when someone asks about deploying to AWS or GCP. It handles infrastructure setup and CI/CD pipelines.
license: MIT
name: cloud-deploy
compatibility: all
---
...
A skill for deploying to cloud providers.
## Core Features
...
Given a target environment, configure:
...
name: cloud-deploy
description: >
  Use this skill when someone asks about deploying to AWS or GCP. It handles
...
Frontmatter reordered. Description block-folded. Lists normalized. Fences fixed. Spacing exact. Done.
